...
--input: takes a string representing a board (stringBoard), a char representing the pawn colour of the current player (c), and an
--int representing the size of one edge of the board (n).
--output: returns a list of ints (listInts) representing the scores of the children of stringBoard (i.e. possible moves). listInts is in the same order
--as the list of children generated by search_pawns.

evaluate_children :: String -> Char -> Int -> [Int]
evaluate_children stringBoard c n = evaluate_children_helper (search_pawns stringBoard c n) c n []

evaluate_children_helper :: [String] -> Char -> Int -> [Int] -> [Int]
evaluate_children_helper listBoards c n listInts
